...
<body class="bg-romantic-pale min-h-screen">
    <!-- The sidebar is included from header.php -->
                ...
                <?php if (count($books) > 0): ?>
                    ...
                    <div class="md:hidden space-y-4 mobile-card">
                        ...
                        <div class="mobile-table-row">
                            ...
                            <div class="mobile-table-cell">
                                <span class="mobile-label">Book Code:</span>
                                <span class="text-gray-700"><?= htmlspecialchars($book['bookcode']) ?></span>
                            </div>
                            <div class="mobile-table-cell">
                                <span class="mobile-label">Status:</span>
                                <span class="<?= $isBorrowed ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800' ?> px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full">
                                    <?= $isBorrowed ? '<i class="fas fa-book-reader mr-1"></i> Borrowed' : '<i class="fas fa-check-circle mr-1"></i> Available' ?>
                                </span>
                            </div>
                            <div class="mobile-table-cell">
                                <span class="mobile-label">Added On:</span>
                                <span class="text-gray-500"><?= date('M d, Y', strtotime($book['created_at'])) ?></span>
                            </div>
    ...
    <!-- JavaScript for responsive sidebar (already included from header.php) -->
</body>
</html>